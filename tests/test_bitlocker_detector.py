"""Testy detektorów szyfrowania bazujących na sygnaturach."""

from __future__ import annotations

from crypto_analyzer.core.models import EncryptionStatus, FileSystemType, Volume
from crypto_analyzer.crypto_detection.bitlocker import BitLockerDetector, SignatureBasedDetector
...
def test_bitlocker_signature_detected() -> None:
    ...
    detector = BitLockerDetector(driver=driver)
    volume = Volume(
        identifier="vol1",
        offset=0,
        size=len(header),
