...
-   Moduł `crypto_detection` z heurystykami dla BitLocker, VeraCrypt, LUKS, FileVault (APFS).
...
-   Prototyp interfejsu w PySide6 (layouty, drzewo, karta podsumowania).
...
-   Finalizacja dokumentacji użytkownika i dewelopera.
